...
//// Static Variables
// Is Initialized?
bool NetworkModelOrnoc::_initialized = false;
// ENet
SInt32 NetworkModelOrnoc::_enet_width;
SInt32 NetworkModelOrnoc::_enet_height;
// Clusters
SInt32 NetworkModelOrnoc::_num_clusters;
SInt32 NetworkModelOrnoc::_cluster_size;
SInt32 NetworkModelOrnoc::_numX_clusters;
SInt32 NetworkModelOrnoc::_numY_clusters;
SInt32 NetworkModelOrnoc::_cluster_width;
SInt32 NetworkModelOrnoc::_cluster_height;
// Sub Clusters
SInt32 NetworkModelOrnoc::_num_access_points_per_cluster;
SInt32 NetworkModelOrnoc::_num_sub_clusters;
SInt32 NetworkModelOrnoc::_numX_sub_clusters;
SInt32 NetworkModelOrnoc::_numY_sub_clusters;
...
NetworkModelOrnoc::GlobalRoutingStrategy NetworkModelOrnoc::_global_routing_strategy;
SInt32 NetworkModelOrnoc::_unicast_distance_threshold;
// Is contention model enabled?
bool NetworkModelOrnoc::_contention_model_enabled;
...
void
NetworkModelOrnoc::initializeANetTopologyParams()
{
   if (_initialized)
      return;
   _initialized = true;
...
void
NetworkModelOrnoc::createANetRouterAndLinkModels()
{
...
void
NetworkModelOrnoc::destroyANetRouterAndLinkModels()
{
   if (isSystemTile(_tile_id))
      return;
...
void
NetworkModelOrnoc::routePacket(const NetPacket& pkt, queue<Hop>& next_hops)
{
...
void
NetworkModelOrnoc::routePacketOnENet(const NetPacket& pkt, tile_id_t pkt_sender, tile_id_t pkt_receiver, queue<Hop>& next_hops)
{
...
void
NetworkModelOrnoc::routePacketOnONet(const NetPacket& pkt, tile_id_t pkt_sender, tile_id_t pkt_receiver, queue<Hop>& next_hops)
{
...
void
NetworkModelOrnoc::outputSummary(ostream &out, const Time& target_completion_time)
{
...
double
NetworkModelOrnoc::computeOpticalLinkLength()
{
...
void
NetworkModelOrnoc::initializeClusters()
{
...
void
NetworkModelOrnoc::initializeAccessPointList(SInt32 cluster_id)
{
...
SInt32
NetworkModelOrnoc::getClusterID(tile_id_t tile_id)
{
...
SInt32
NetworkModelOrnoc::getSubClusterID(tile_id_t tile_id)
{
   SInt32 cx, cy;
...
tile_id_t
NetworkModelOrnoc::getNearestAccessPoint(tile_id_t tile_id)
{
   SInt32 cluster_id = getClusterID(tile_id);
...
bool
NetworkModelOrnoc::isAccessPoint(tile_id_t tile_id)
{
   return (tile_id == getNearestAccessPoint(tile_id));
}

tile_id_t
NetworkModelOrnoc::getTileIDWithOpticalHub(SInt32 cluster_id)
{
   // Consider a mesh formed by the clusters
   SInt32 cluster_mesh_width;
   cluster_mesh_width = _enet_width / _cluster_width;
...
SInt32
NetworkModelOrnoc::getIndexInList(tile_id_t tile_id, vector<tile_id_t>& tile_id_list)
{
   SInt32 idx = 0;
...
SInt32
NetworkModelOrnoc::computeNumHopsOnENet(tile_id_t sender, tile_id_t receiver)
{
   SInt32 sx, sy, dx, dy;
...
void
NetworkModelOrnoc::computePositionOnENet(tile_id_t tile_id, SInt32& x, SInt32& y)
{
...
tile_id_t
NetworkModelOrnoc::computeTileIDOnENet(SInt32 x, SInt32 y)
{
...
NetworkModelOrnoc::GlobalRoutingStrategy
NetworkModelOrnoc::parseGlobalRoutingStrategy(string strategy)
{
...
NetworkModelOrnoc::GlobalRoute
NetworkModelOrnoc::computeGlobalRoute(tile_id_t sender, tile_id_t receiver)
{
...
NetworkModelOrnoc::ReceiveNetType
NetworkModelOrnoc::parseReceiveNetType(string str)
{
   if (str == "btree")
      return BTREE;
   else if (str == "star")
...
SInt32
NetworkModelOrnoc::computeReceiveNetID(tile_id_t sender)
{
...
bool
NetworkModelOrnoc::isTileCountPermissible(SInt32 tile_count)
{
...
NetworkModelOrnoc::computeMemoryControllerPositions(SInt32 num_memory_controllers, SInt32 tile_count)
{
...
NetworkModelOrnoc::computeProcessToTileMapping()
{
   // Initialize _total_tiles, _cluster_size, _sqrt_cluster_size, _mesh_width, _mesh_height, _num_clusters
   initializeANetTopologyParams();
...
void
NetworkModelOrnoc::outputEventCountSummary(ostream& out)
{
...
void
NetworkModelOrnoc::outputContentionModelsSummary(ostream& out)
{
